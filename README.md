...
```text
apps/api      API 服务，PostgreSQL 数据库存储，支持 Azure OpenAI Responses API
...
```bash
PORT=4000
DATABASE_URL=postgres://user:password@host:5432/findit
...
APPLE_IAP_SHARED_SECRET=your-app-store-shared-secret
```
